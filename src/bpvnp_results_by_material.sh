#!/bin/bash
# creates a pipe-delimited CSV that shows:

echo "material|wins|draws|losses" > ../data/bpvnp_by_material.csv

#33 points of material
cat ../data/white_bpvnp.pgn ../data/black_bpvnp.pgn | pgn-extract -s -z tags/bpvnpraw0 -otmp0 -nret0
...
echo "33|${win}|${draw}|${loss}" >> ../data/bpvnp_by_material.csv
...
echo "32|${win}|${draw}|${loss}" >> ../data/bpvnp_by_material.csv
...
echo "31|${win}|${draw}|${loss}" >> ../data/bpvnp_by_material.csv
...
echo "30|${win}|${draw}|${loss}" >> ../data/bpvnp_by_material.csv
...
echo "29|${win}|${draw}|${loss}" >> ../data/bpvnp_by_material.csv
...
echo "28|${win}|${draw}|${loss}" >> ../data/bpvnp_by_material.csv
