#!/bin/bash
# creates a pipe-delimited CSV in /data/ to be read into a Pandas DataFrame

# header line of the CSV:
echo "num_pawns|wins|draws|losses" > ../data/csv/qv2r_by_pawns.csv

cat ../data/pgn/white_qv2r.pgn ../data/pgn/black_qv2r.pgn > all_qv2r.pgn
...
echo "'7+'|$((${wins7}+${wins8}))|$((${draws8}+${draws7}))|$((${losses8}+${losses7}))" >> ../data/csv/qv2r_by_pawns.csv
...
do
    ...
    echo "'${i}'|${wins}|${draws}|${losses}" >> ../data/csv/qv2r_by_pawns.csv
...
echo "'1-'|$((${wins1}+${wins0}))|$((${draws1}+${draws0}))|$((${losses1}+${losses0}))" >> ../data/csv/qv2r_by_pawns.csv
